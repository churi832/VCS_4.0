...
{
    /// <summary>
    /// X20 analog input module, 4 inputs, ±10 V or 0 to 20 mA, 16-bit converter resolution, configurable input filter, oscilloscope functions
    /// </summary>
    [Serializable]
    public class IoTermBnrX20AI4632 : _IoTermBnr
    {
		public IoTermBnrX20AI4632()
		{
			m_ChannelCount = 4;
			m_Name = "AI4632";
