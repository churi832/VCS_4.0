...
{
    /// <summary>
    /// X20 analog output module, 2 outputs, ±10 V or 0 to 20 mA, 16-bit converter resolution, NetTime function	
    /// </summary>
    [Serializable]
    public class IoTermBnrX20AO2632 : _IoTermBnr
    {
		public IoTermBnrX20AO2632()
		{
			m_ChannelCount = 2;
			m_Name = "AO2632";
