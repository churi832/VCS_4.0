...
{
    public class VehicleIF_CommandStatusReply : VehicleIF, IVehicleIF
    {
        #region Fields
        public string TransferCommandID = string.Empty;
        public CommandStatusCode StatusCode = CommandStatusCode.NotReceived;
        #endregion
        ...
        #region Constructors
        public VehicleIF_CommandStatusReply()
        {
            try
            {
                _MessageCode = IFMessage.CommandStatusReply;  //0x1E
            }
            catch
            {
            }
        }
        public VehicleIF_CommandStatusReply(int systemByte)
        {
            try
            {
                _MessageCode = IFMessage.CommandStatusReply;  //0x1E
        ...
        public bool SetDataFromStream(byte[] stream)
        {
            try
            {
                ...
                StatusCode = (CommandStatusCode)stream[offset++];
        ...
        public byte[] GetStreamFromDataOrNull()
        {
            try
            {
                ...
                byteStream.Add((byte)StatusCode);
        ...
        public List<String> GetLogData()
        {
            try
            {
                ...
                result.Add(string.Format("\t\tCommand Status : {0}", StatusCode));
