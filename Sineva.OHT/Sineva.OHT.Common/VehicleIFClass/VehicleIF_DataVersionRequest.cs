...
{
    public class VehicleIF_DataVersionRequest : VehicleIF, IVehicleIF
    {
        #region Fields
        #endregion
        ...
        #region Constructors
        public VehicleIF_DataVersionRequest()
        {
            try
            {
                _MessageCode = IFMessage.DataVersionRequest;
            }
            catch
            {
            }
        }
        public VehicleIF_DataVersionRequest(int systemByte)
        {
            try
            {
                _MessageCode = IFMessage.DataVersionRequest;
