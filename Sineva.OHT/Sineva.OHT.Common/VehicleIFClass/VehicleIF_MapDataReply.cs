...
{
    public class VehicleIF_MapDataReply : VehicleIF, IVehicleIF
    {
        #region Fields
        ...
        #region Constructors
        public VehicleIF_MapDataReply()
        {
            try
            {
                _MessageCode = IFMessage.MapDataReply;
            }
            catch
            {
            }
        }
        public VehicleIF_MapDataReply(int systemByte)
        {
            try
            {
                _MessageCode = IFMessage.MapDataReply;
