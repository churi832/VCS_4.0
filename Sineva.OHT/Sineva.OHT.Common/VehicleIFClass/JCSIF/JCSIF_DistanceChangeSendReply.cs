...
{
    public class JCSIF_DistanceChangeSendReply : JCSIF, IJCSIF
    {
        #region Fields
        ...
        #region Constructors
        public JCSIF_DistanceChangeSendReply()
        {
            try
            {
                _MessageCode = JCSIFMessage.JunctionDistanceChangeSendReply;
            }
            catch
            {
            }
        }
        public JCSIF_DistanceChangeSendReply(int systemByte)
        {
            try
            {
                _MessageCode = JCSIFMessage.JunctionDistanceChangeSendReply;
