...
{
    public class JCSIF_PassRequestReply : JCSIF, IJCSIF
    {
        #region Fields
        public int JuctionPointNumber = 0;
        public JCSType JuctionType = 0;
        public JunctionPassRequestResult PassRequestResult = JunctionPassRequestResult.No_Result;
        #endregion
        ...
        #region Constructors
        public JCSIF_PassRequestReply()
        {
            try
            {
                _MessageCode = JCSIFMessage.JunctionPassRequestReply;
            }
            catch
            {
            }
        }
        public JCSIF_PassRequestReply(int systemByte)
        {
            try
            {
                _MessageCode = JCSIFMessage.JunctionPassRequestReply;
        ...
        public bool SetDataFromStream(byte[] stream)
        {
            try
            {
                ...
                PassRequestResult = (JunctionPassRequestResult)(stream[offset++]);
        ...
        public byte[] GetStreamFromDataOrNull()
        {
            try
            {
                ...
                byteStream.Add(Convert.ToByte(PassRequestResult));
                byteStream.Add(ETX);
        ...
        public List<String> GetLogData()
        {
            try
            {
                ...
                result.Add(string.Format("\t\tPass Request Result : {0}", PassRequestResult));
