...
{
    public class JCSIF_PassStatusChangeSendReply : JCSIF, IJCSIF
    {
        #region Fields
        ...
        #region Constructors
        public JCSIF_PassStatusChangeSendReply()
        {
            try
            {
                _MessageCode = JCSIFMessage.JunctionPassStatusChangeSendReply;
            }
            catch
            {
            }
        }
        public JCSIF_PassStatusChangeSendReply(int systemByte)
        {
            try
            {
                _MessageCode = JCSIFMessage.JunctionPassStatusChangeSendReply;
