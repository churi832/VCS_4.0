...
{
    public class JCSIF_InitialStateReply : JCSIF, IJCSIF
    {
        #region Fields
        public int JuctionPointNumber = 0;
        public JCSType JuctionType = 0;
        public JunctionState PassState = JunctionState.None;
        #endregion
        ...
        #region Constructors
        public JCSIF_InitialStateReply()
        {
            try
            {
                _MessageCode = JCSIFMessage.InitialStateReply;
            }
            catch
            {
            }
        }
        public JCSIF_InitialStateReply(int systemByte)
        {
            try
            {
                _MessageCode = JCSIFMessage.InitialStateReply;
        ...
        public bool SetDataFromStream(byte[] stream)
        {
            try
            {
                ...
                PassState = (JunctionState)(stream[offset++]);
        ...
        public byte[] GetStreamFromDataOrNull()
        {
            try
            {
                ...
                byteStream.Add(Convert.ToByte(PassState));
                byteStream.Add(ETX);
        ...
        public List<String> GetLogData()
        {
            try
            {
                ...
                result.Add(string.Format("\t\tPassState : {0}", PassState));
