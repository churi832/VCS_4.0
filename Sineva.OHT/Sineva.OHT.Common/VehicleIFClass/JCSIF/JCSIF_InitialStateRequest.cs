...
{
    public class JCSIF_InitialStateRequest : JCSIF, IJCSIF
    {
        #region Fields
        ...
        #region Constructors
        public JCSIF_InitialStateRequest()
        {
            try
            {
                _MessageCode = JCSIFMessage.InitialStateRequest;
            }
            catch
            {
            }
        }
        public JCSIF_InitialStateRequest(int systemByte)
        {
            try
            {
                _MessageCode = JCSIFMessage.InitialStateRequest;
