...
{
    public class JCSIF_PassRequest : JCSIF, IJCSIF
    {
        #region Fields
        ...
        #region Constructors
        public JCSIF_PassRequest()
        {
            try
            {
                _MessageCode = JCSIFMessage.JunctionPassRequest;
            }
            catch
            {
            }
        }
        public JCSIF_PassRequest(int systemByte)
        {
            try
            {
                _MessageCode = JCSIFMessage.JunctionPassRequest;
