...
{
    public class VehicleIF_MapDataRequest : VehicleIF, IVehicleIF
    {
        #region Fields
        ...
        #region Constructors
        public VehicleIF_MapDataRequest()
        {
            try
            {
                _MessageCode = IFMessage.MapDataRequest;
            }
            catch
            {
            }
        }
        public VehicleIF_MapDataRequest(int systemByte)
        {
            try
            {
                _MessageCode = IFMessage.MapDataRequest;
